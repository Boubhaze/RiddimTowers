...
const App: React.FC = () => {
  ...
  return (
    <div className={`${darkMode ? 'dark' : ''} transition-colors duration-300`}>
      {view === 'LANDING' ? (
          <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white flex flex-col p-6 sm:p-12 selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black relative overflow-hidden transition-colors duration-300">
              ...
              <nav className="flex justify-between items-start z-10 mb-8">
                  <div className="text-xs font-mono uppercase tracking-widest border-b border-black dark:border-white pb-1">V2.0 // SYSTEM_READY</div>
                  <div className="flex items-center gap-4">
                      ...
                      <button 
                        ...
                        className="w-8 h-8 flex items-center justify-center border border-black dark:border-white hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all"
                      >
                         {darkMode ? '☀' : '☾'}
                      </button>
                  </div>
              ...
              <main className="w-full z-10 flex-1 flex flex-col justify-center gap-12">
                  ...
                  <h1 className="text-[11vw] font-black tracking-tighter leading-none animate-slide-up text-black dark:text-white whitespace-nowrap text-center xl:text-left mt-4 xl:mt-0 transition-colors duration-300">
                      RIDDIM TOWER
                  </h1>
                  ...
                  <div className="grid grid-cols-1 xl:grid-cols-12 gap-12 items-end">
                      ...
                      <div className="xl:col-span-5 flex flex-col gap-8 animate-slide-up" style={{animationDelay: '0.2s'}}>
                          <div className="h-[4px] w-24 bg-black dark:bg-white mb-2"></div>
                          <p className="text-xl sm:text-2xl font-medium leading-tight">
                              Vivez l'Expérience Sound System.
                          </p>
                          <p className="text-sm font-mono text-gray-600 dark:text-gray-400 leading-relaxed uppercase tracking-wide text-justify">
                              <strong className="text-black dark:text-white">Tour de Contrôle Virtuelle.</strong><br/>
                          ...
                          <div className="pt-4">
                              <button 
                                onClick={enterApp}
                                className="w-full sm:w-auto group flex items-center justify-center gap-6 text-sm font-bold uppercase tracking-widest bg-black text-white dark:bg-white dark:text-black px-10 py-5 hover:bg-gray-900 dark:hover:bg-gray-100 transition-all shadow-[8px_8px_0px_0px_rgba(0,0,0,0.2)] hover:translate-y-[-2px] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,0.2)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,0.2)]"
                              >
                                  START THE SESSION
              ...
              <footer className="text-[10px] font-mono text-gray-400 uppercase tracking-widest flex flex-col sm:flex-row justify-between z-10 mt-12 border-t border-gray-100 dark:border-gray-800 pt-4">
                  <span>© 2025 Riddim Tower Project</span>
                  <span className="mt-2 sm:mt-0">Created by <strong className="text-black dark:text-white">Raw Powa Studio</strong></span>
              </footer>
          </div>
      ) : (
        <div className="min-h-screen bg-[#FAFAFA] dark:bg-black text-black dark:text-white flex flex-col p-4 font-sans transition-colors duration-300">
        
          {/* APP HEADER */}
          <header className="w-full mx-auto max-w-[1400px] flex items-center justify-between mb-6 border-b border-black dark:border-white pb-4 pt-2">
            <div className="flex items-center gap-4">
                <button 
                    onClick={() => setView('LANDING')}
                    className="w-8 h-8 flex items-center justify-center border border-transparent hover:border-black dark:hover:border-white hover:bg-white dark:hover:bg-gray-900 transition-all rounded-full group"
                    title="Return Home"
                >
                    <span className="group-hover:-translate-x-[1px] transition-transform">←</span>
                </button>
                <h1 className="text-xl font-bold tracking-tight border-r border-black dark:border-white pr-4 mr-4">RIDDIM TOWER</h1>
                <span className="text-[10px] font-mono bg-black dark:bg-white text-white dark:text-black px-2 py-0.5 rounded-full">ONLINE</span>
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-2">
                    <button 
                        ...
                        className="w-20 h-8 border border-black dark:border-white flex items-center justify-center text-xs font-bold uppercase hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors disabled:opacity-30"
                    >
                    ...
                    <button 
                        ...
                        disabled={!engine.isReady}
                        className="w-20 h-8 border border-black dark:border-white flex items-center justify-center text-xs font-bold uppercase hover:bg-red-600 hover:text-white hover:border-red-600 dark:hover:border-red-600 transition-colors disabled:opacity-30"
                    >
                        STOP
                    </button>
                </div>
          ...
          <main className="w-full mx-auto max-w-[1400px] grid grid-cols-1 lg:grid-cols-12 gap-8 items-start h-full pb-12">
            ...
            <section className="lg:col-span-8 flex flex-col gap-6 shadow-sm">
                ...
                <div className="h-32 w-full shadow-[0_5px_15px_-5px_rgba(0,0,0,0.05)] dark:shadow-none">
                     <GraphicEQ 
                        gains={eqState} 
                ...
                <div className="h-24 w-full border border-black dark:border-white p-[1px] bg-white dark:bg-black">
                      <Visualizer analyser={engine.masterAnalyser} darkMode={darkMode} />
                </div>

                {/* Preamp (Full Width) */}
                <div className="h-[520px] w-full shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] dark:shadow-none">
                    <Preamp 
                        state={preampState} 
            ...
            <section className="lg:col-span-4 flex flex-col gap-6">
                <div className="h-72 w-full shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)] dark:shadow-none">
                    <Siren 
                        model={sirenModel} 
                        state={sirenState} 
                ...
                <div className="h-64 w-full shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)] dark:shadow-none">
                    <Delay 
                        model={delayModel}
                        state={delayState}
                ...
                {/* Guide Opérateur */}
                <div className="mt-auto pt-6 border-t border-black/10 dark:border-white/20">
                    <h4 className="text-[10px] font-bold uppercase mb-3">Guide Opérateur</h4>
                    <ul className="text-[10px] text-gray-500 dark:text-gray-400 font-mono space-y-2 leading-relaxed list-disc pl-3">
                        ...
                        <li><strong>Dub Echo:</strong> Montez les <span className="text-black dark:text-white font-bold">SEND M/S</span> pour envoyer le signal dans la chambre d'écho.</li>
                    </ul>
                </div>
            </section>
